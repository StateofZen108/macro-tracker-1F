...
const sharedPreviewFlags = {
  ...
  VITE_FF_UNIFIED_LOGGER_V1: 'true',
  VITE_FF_AI_MEAL_CAPTURE_V1: 'true',
  VITE_FF_FOOD_DATABASE_TRUST_V1: 'true',
  VITE_FF_CUT_OS_EXPENDITURE_VALIDATION_V1: 'true',
  VITE_FF_COACH_LIVE_PROVIDER_V1: 'true',
  VITE_FF_TRAINING_PRESERVATION_OS_V1: 'true',
