...
export type DiagnosticsEventType =
  ...
  | 'ui.premium.rendered'
  | 'ui.summary.v2_rendered'
  | 'ui.fast_log.v2_rendered'
  | 'ui.meal_ledger.v2_rendered'
  | 'ui.proof_strip.rendered'
  | 'ui.visual_gate_verified'
  | 'ui.premium.flag_changed'
  | 'ui.summary.date_changed'
  | 'ui.layout.viewport_changed'
  | 'ui.proof_strip.hidden_missing_model'
  | 'ui.accessibility_gate_failed'
