    ...
    >
      <div className="flex items-center gap-3 px-4 py-4">
        <button type="button" className="flex flex-1 items-start gap-3 text-left" onClick={onToggle}>
          <div
            className={`mt-1 rounded-full bg-teal-100 p-1 text-teal-700 transition dark:bg-teal-500/10 dark:text-teal-300 ${
          ...
          <div>
            <p className="font-display text-2xl text-slate-900 dark:text-white">{MEAL_LABELS[meal]}</p>
